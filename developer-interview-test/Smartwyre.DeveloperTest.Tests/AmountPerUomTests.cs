...
{
    private AmountPerUom Instance { get; } = new AmountPerUom();
    ...
    [Theory]
    [InlineData(IncentiveType.AmountPerUom, SupportedIncentiveType.AmountPerUom, 1, 1, true)]
    [InlineData(IncentiveType.AmountPerUom, SupportedIncentiveType.AmountPerUom, 0, 0, false)]
    [InlineData(IncentiveType.AmountPerUom, SupportedIncentiveType.AmountPerUom, 1, 0, false)]
    [InlineData(IncentiveType.AmountPerUom, SupportedIncentiveType.AmountPerUom, 0, 1, false)]
    [InlineData(IncentiveType.AmountPerUom, SupportedIncentiveType.FixedCashAmount, 1, 1, false)]
    [InlineData(IncentiveType.AmountPerUom, SupportedIncentiveType.FixedRateRebate, 1, 1, false)]
    [InlineData(IncentiveType.FixedCashAmount, SupportedIncentiveType.AmountPerUom, 1, 1, false)]
    [InlineData(IncentiveType.FixedCashAmount, SupportedIncentiveType.FixedCashAmount, 1, 1, false)]
    [InlineData(IncentiveType.FixedCashAmount, SupportedIncentiveType.FixedRateRebate, 1, 1, false)]
    [InlineData(IncentiveType.FixedRateRebate, SupportedIncentiveType.AmountPerUom, 1, 1, false)]
    [InlineData(IncentiveType.FixedRateRebate, SupportedIncentiveType.FixedCashAmount, 1, 1, false)]
    [InlineData(IncentiveType.FixedRateRebate, SupportedIncentiveType.FixedRateRebate, 1, 1, false)]
    public void IsValid_Success(IncentiveType incentive, SupportedIncentiveType supported, decimal amount, decimal volume, bool isSupported)
    {
        var request =
            new RebateCalculationRequest
            {
    ...
    [InlineData(1, 2, 2)]
    [InlineData(2, 2, 4)]
    public void CalculateAmount_Success(decimal amount, decimal volume, decimal calculated)
    {
        var request =
            new RebateCalculationRequest
            {
                Rebate = new Rebate { Amount = amount, Incentive = IncentiveType.AmountPerUom },
